...
<body>
	<img class='header-image top-margin' src='image/Header-Image.png' />
    
	<div class="container">
  <div class="row top-margin">
    <div class="col-md-6">
	 <img style="float:left;" id='menu-teacher-signin' src='image/Teacherlogo.png' />
    
    </div>
    <div class="col-md-6">
     <img style="float:right;" id='menu-student-signin' src='image/Studentlogo.png' />
    </div>
  </div>  
		<div class="row">
    <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-md-5"> 
      <img src="image/student.png" style="max-width:69%">
      </div>
      <div class="col-md-7">
      <h1> STUDENT LOGIN </h1> 
   ...
   <div class="row">
      <div class="col-md-5"> 
      <img src="image/teacher.png" style="max-width:100%">
      </div>
      <div class="col-md-7">
      <h1> TEACHER LOGIN </h1> 
        <form method='post' action='controller.php'>
        ...
        <form method='post' action='controller.php'>
            ...
            <div id="student_only">
                ...
                <select class="form-control" id="select" name="select">
                    <option value="1">Basics of programming</option>
                    <option value="2">Windows operating system</option>
                    <option value="3">Data processing with Excel</option>
                    <option value="4">English for CA -students</option>
                    <option value="5">Orientation for studies</option>
                    <option value="6">Databases</option>
                    <option value="7">Finnish 1</option>
                    <option value="8">Introduction to object-oriented programming and project</option>
                    <option value="9">Operating systems and user-rights</option>
                    <option value="10">Software modelling language and methods</option>
                    <option value="11">Website user interface</option>
                    <option value="12">Web programming</option>
                    <option value="13">Content management systems</option>
                    <option value="14">Basics of Python</option>
                    <option value="15">Finnish 2</option>
