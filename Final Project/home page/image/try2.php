...
.carousel-item{
  ...
  #carouselExampleDark > div.carousel-inner > div.carousel-item.active > div > a{
      ...
      <nav class="navbar navbar-expand-lg navbar-white">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img src="photo/ko.jpg" class="d-block w-100"   alt="...">
          ...
          <div class="carousel-item" data-bs-interval="2000">
            ...
            <a href ="#" class="btn btn-lg bth-primary">Sign up Teacher</a>
            <a href ="#" class="btn btn-lg bth-primary">Sign up Student</a>
       ...
       <article>
        ...
        <div class="row">
            <div class =" row-md-5">
                <p>Aseman private school is one of the best, reputed, well established educational institution  which is located on the center of hyvinkää nearby Helsinki.
   Various intellectual, head teachers, social workers, other  teachers as well as members of the community and members of the school  management committee
    highly contributed for the establishment of this  educational institution. It was established in 2018. Innumerable personalities  play prominent role for the establishment 
	of this school.
                </p>
            </div>     
          <div class="col-md-4">
          <br><img src="photo/scl.jpg" width="450" height="auto">
        ...
        <div class ="row">
            ...
            <br><img src="photo/cmp.jpg" width="287" height="auto">
                
                </p>
            </div>     
          <div class="col-md-4"text-align= "center"><h5>Science  Laboratories</h5><br>
          <br><img src="photo/sc.jpg" width="287" height="auto">
                
             </div>
          <div class="col-md-4"><h5>Peaceful Library</h5><br>
          <br><img src="photo/li.jpg" width="287" height="auto">
     ...
     <footer class="bg-2AB2E2 text-white pt-5 pb-4">
      ...
      <a class="gotopbtn" href="#"><img src="photo/next.png" height=32 width=34 border-radius=150px></a>
