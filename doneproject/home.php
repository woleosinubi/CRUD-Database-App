...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/stylest.css">
...
<body>
	<img class='header-image top-margin' src='img/Header-Image.png' />
    
	<div class="container">
  <div class="row top-margin">
    <div class="col-md-6">
	 <img style="float:left;" id='menu-teacher-signin' src='img/Teacherlogo.png' />
    
    </div>
    <div class="col-md-6">
     <img style="float:right;" id='menu-student-signin' src='img/Studentlogo.png' />
    </div>
  </div>  
		<div class="row">
    <div class="col-md-12">
